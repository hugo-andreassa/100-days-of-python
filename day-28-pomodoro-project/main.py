...
def count_down(count):
    ...
    if count > 0:
        ...
        lbl_check_marks.config(text="✓" * work_sessions)
...
lbl_title = Label(text="Timer", font=(FONT_NAME, 35, "bold"), bg=YELLOW, fg=GREEN)
...
lbl_check_marks = Label(font=(FONT_NAME, 15, "bold"), bg=YELLOW, fg=GREEN)
lbl_check_marks.grid(column=1, row=4)
